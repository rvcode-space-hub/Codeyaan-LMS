...
class __Mustache_1a04dacf80279deeeb0961f86a684910 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionAb8b506d75e7328867681204e0b7d139($context, $indent, $value);
        $value = $context->find('haschildren');
        if (empty($value)) {
...
';
            ...
            $buffer .= $this->section7d925107462d63c8b761ba75f1f77858($context, $indent, $value);
            $value = $context->find('istablist');
            if (empty($value)) {
...
';
    ...
    private function sectionAb8b506d75e7328867681204e0b7d139(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section7d925107462d63c8b761ba75f1f77858(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
