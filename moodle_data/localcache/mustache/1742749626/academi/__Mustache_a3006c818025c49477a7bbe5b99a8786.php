...
';
        if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
            $context->pushBlockContext(array(
                ...
                'drawerheading' => array($this, 'block02f871ffa5e96ac2e8510eb659f5ced7'),
                'drawercontent' => array($this, 'blockA88088b716463ab73ce6f5dcf32bb146'),
...
';
    ...
    public function block02f871ffa5e96ac2e8510eb659f5ced7($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function blockA88088b716463ab73ce6f5dcf32bb146($context)
    {
        $indent = $buffer = '';
